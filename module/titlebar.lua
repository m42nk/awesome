	...
	function(c)
		...
		if c.type == 'normal' then
			...
			if c.class == 'kitty' then
				create_vertical_bar(c, 'right', '#00000099', beautiful.titlebar_size)

			elseif c.class == 'firefox' then
				create_vertical_bar(c, 'right', beautiful.background, beautiful.titlebar_size)
			...
			elseif c.class == 'TelegramDesktop' then
				create_vertical_bar(c, 'right', '#17212b', beautiful.titlebar_size)
		...
		elseif c.type == 'dialog' then
			...
			if c.role == 'GtkFileChooserDialog' then
				create_vertical_bar_dialog(c, 'right',
					beautiful.gtk.get_theme_variables().bg_color, beautiful.titlebar_size)
			...
			elseif c.class == 'Arandr' then
				...
				create_vertical_bar_dialog(c, 'right', '#00000099', beautiful.titlebar_size)
			end
